class SegmentTestRun
{
    public static void main(String[]args)
    {
        ...
        Segment2 s2 = new Segment2(1, 1, 5, 2);
        Segment2 s3 = new Segment2(s1);
        ...
        Segment2 s5 = new Segment2(p1, p2);
        Segment2 s6 = new Segment2(s5);
        ...
        //trapeze test
        Segment2 s10 = new Segment2(2, 2, 12, 2);
        Segment2 s11 = new Segment2(2, 0, 12, 0);
        Segment2 s12 = new Segment2(13, 2, 15, 2);
        ...
        Segment2 s20 = new Segment2(p20, 4);
        System.out.println("(6.0,2.0)---(10.0,2.0) Test Builder4: " + s20.toString());
    }
}
